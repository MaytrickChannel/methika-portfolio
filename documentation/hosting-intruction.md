...
- ssh into the server
    - For Mac and Linux: `ssh root@methika-developer.com`
    - For Windows: Set up a new PuTTY session
        ...
        - **Session**
            ...
            - Click Save
- create user
    - `useradd -m -s /bin/bash -g users -G sudo mnithimatechak`
    - replace mnithimatechak with your own
- create password
    - `passwd mnithimatechak`
- Move .ssh key file
    - `cp -r .ssh /home/mnithimatechak`
- change ownership of the .ssh directory
    - `cd /home/mnithimatechak`
    - `chown -R mnithimatechak:users .ssh/`


- Test Changes
    - `exit`
    - Mac/Linux: `ssh mnithimatechak@methika-developer.com`
    - Windows:
        - **Session**
            - Click pwp
            - Click Load
...
- reboot
    - `sudo reboot`
- ssh back in
- `ssh mnithimatechak@methika-developer.com`
...
- create a directory for your deployment
    - `sudo mkdir /var/www/methika-developer.com/html`
- fix permissions
    - `sudo chown -R $USER:users /var/www/methika-developer.com/html`
...
- `sudo vim /etc/nginx/sites-available/methika-developer.com`
...
server {
    ...
    root /var/www/methika-developer.com/html;
    index index.html index.htm index.nginx-debian.html;

    server_name methika-developer.com www.methika-developer.com;
...
- create a symlink to the sites-enabled directory
    - `sudo ln -s /etc/nginx/sites-available/methika-developer.com /etc/nginx/sites-enabled/`
...
- Create a new ssh key on your server in the .ssh directory
    - `ssh-keygen -t ed25519 -C  "github Deploy Key" -f /home/mnithimatechak/.ssh/github_deploy_key`
    - Don't enter a passphrase
        - hit enter twice
- Copy the public key into your authorized keys file
    - `cat /home/mnithimatechak/.ssh/github_deploy_key.pub >> /home/mnithimatechak/.ssh/authorized_keys`
...
- Copy the private key to your clipboard **(this is a very dangerous operation do not share this key with anyone )**
    ...
    - `cat /home/mnithimatechak/.ssh/github_deploy_key`
  ...
  deploy:
    ...
    steps:
      ...
      - name: Deploy to server
        run: |
         ssh-keyscan -H methika-developer.com >> ~/.ssh/known_hosts 
         scp -r ./dist/* methika-developer@methika-developer.com:/var/www/methika-developer.com/html
```
